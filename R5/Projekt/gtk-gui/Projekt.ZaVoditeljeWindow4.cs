...
namespace Projekt
{
	public partial class ZaVoditeljeWindow4
	{
		...
		protected virtual void Build()
		{
			...
			// Widget Projekt.ZaVoditeljeWindow4
			this.WidthRequest = 600;
			this.HeightRequest = 400;
			this.Name = "Projekt.ZaVoditeljeWindow4";
			this.Title = global::Mono.Unix.Catalog.GetString("Sustav rezervacija za nacionalne parkove RH");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.Modal = true;
			// Container child Projekt.ZaVoditeljeWindow4.Gtk.Container+ContainerChild
