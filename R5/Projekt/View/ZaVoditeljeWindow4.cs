...
namespace Projekt
{
	public partial class ZaVoditeljeWindow4 : Gtk.Window
	{
		public ZaVoditeljeWindow4() :
		...
		protected void OnButton15Clicked(object sender, EventArgs e)
		{
			...
			else
			{
				...
				if (z == 0)
				{
					...
					nodeview1.AppendColumn("Karte - djeca", new Gtk.CellRendererText(), "text", 6);
					nodeview1.AppendColumn("Karte - odrasli", new Gtk.CellRendererText(), "text", 7);
